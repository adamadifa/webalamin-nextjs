        ...
        <div className="md:w-1/2 flex items-center justify-center px-4 py-12 bg-gradient-to-br from-white via-teal-50 to-white relative overflow-hidden">
          ...
          <div className="w-full max-w-xl relative z-10">
            <div className="flex flex-col items-center mb-8">
              ...
              <p className="text-gray-500 text-center text-sm max-w-md">Isi data diri dengan lengkap dan benar untuk proses pendaftaran siswa baru di Pesantren Persatuan Islam 80 Al Amin.</p>
