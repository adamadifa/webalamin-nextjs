  ...
  return (
    <>
      ...
      <div className="relative bg-gradient-to-b from-[#f0f5ff] to-white min-h-screen font-sans">
        ...
        <div className="absolute top-[-100px] left-0 w-[300px] h-[300px] bg-gradient-to-tr from-teal-500 via-teal-300 to-teal-200 opacity-35 rounded-full blur-3xl z-0" />
        ...
        <div className="absolute bottom-[-100px] right-0 w-[280px] h-[280px] bg-gradient-to-tr from-teal-400 via-teal-300 to-teal-200 opacity-30 rounded-full blur-3xl z-0" />
