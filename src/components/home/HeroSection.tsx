...
import { Book, Monitor, Edit, Award, User } from "react-feather";
                ...
                <main className="relative grid grid-cols-1 md:grid-cols-12 items-end pt-8 md:pt-12 pb-24 md:pb-32 z-10 gap-y-8 md:gap-x-8">
                    ...
                    <div className="block md:hidden mb-0 pb-2 overflow-visible">
                        <div className="relative flex justify-center items-center">
                            ...
                            <div className="absolute -top-2 left-4 flex items-center gap-2 z-20 animate-float-y">
                                ...
                                <span className="bg-white/90 text-teal-700 text-xs font-semibold px-2 py-1 rounded shadow-md">Tauhidullah</span>
                            </div>
                            <div className="absolute top-6 right-2 flex items-center gap-2 z-20 animate-float-x">
                                ...
                                <span className="bg-white/90 text-yellow-700 text-xs font-semibold px-2 py-1 rounded shadow-md">Leadership</span>
                            </div>
                            <div className="absolute left-2 bottom-20 flex items-center gap-2 z-20 float-y-delay">
                                <div className="bg-yellow-300 p-2 rounded-full shadow-lg">
                                    <Edit size={15} className="text-white" />
                                </div>
                                <span className="bg-white/90 text-yellow-700 text-xs font-semibold px-2 py-1 rounded shadow-md">Kemandirian</span>
                            </div>
                            <div className="absolute right-4 bottom-16 flex items-center gap-2 z-20 float-x-delay">
                                <div className="bg-teal-400 p-2 rounded-full shadow-lg">
                                    <Award size={15} className="text-white" />
                                </div>
                                <span className="bg-white/90 text-teal-700 text-xs font-semibold px-2 py-1 rounded shadow-md">Rahmatanlil'alamiin</span>
                            </div>
                            {/* Gambar utama */}
                            <img
                    ...
                    <div className="col-span-1 md:col-span-6 flex flex-col justify-end items-center text-center px-2 md:px-0">
                        <h2 className="text-2xl sm:text-3xl md:text-5xl md:text-6xl font-extrabold text-gray-800 leading-[1] mt-0">
                            Pesantren Persatuan Islam 80 Al Amin
                        </h2>
                        <p className="mt-0 text-gray-500 max-w-lg mx-auto">
                            Class-id is an online learning platform that offers various premium courses for your skill development.
                        </p>
                        <div className="flex justify-center items-center space-x-4 mt-4 mb-6 mb-8">
                            <Link href="/register" className="bg-teal-600 text-white font-semibold px-6 py-3 rounded-lg flex items-center space-x-2 hover:bg-teal-700 transition-transform hover:scale-105">
                        ...
                        <div className="relative">
                            ...
                            <div className="absolute top-1/2 right-[-40px] md:right-[-80px] -translate-y-1/2 flex flex-col items-end z-20 animate-float-badge">
                                <div className="bg-gradient-to-br from-white via-slate-100 to-teal-500 rounded-2xl px-5 py-3 shadow-2xl flex items-center space-x-3 border border-white/70 backdrop-blur-md">
                                    <svg width="28" height="28" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="12" fill="#38b2ac" /><path d="M9.5 13.5l2 2 3-4" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>
                                    <div>
                                        <div className="text-2xl md:text-3xl font-extrabold text-gray-800 leading-tight">88%</div>
                                        <div className="text-xs md:text-sm font-semibold text-gray-700 -mt-1">Lulusan Diterima<br className="hidden md:block" /> di Kampus Favorit</div>
                                    </div>
                                </div>
                            </div>
                            <img
